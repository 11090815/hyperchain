...
func (a *Fp256bn) G1ToProto(g1 *mathlib.G1) *ECP {
	if g1 == nil {
		panic("nil argument")
	}
...
func (a *Fp256bn) G1FromRawBytes(raw []byte) (*mathlib.G1, error) {
	l := len(raw) / 2
...
func (a *Fp256bn) G1FromProto(e *ECP) (*mathlib.G1, error) {
	if e == nil {
...
func (a *Fp256bn) G2ToProto(g2 *mathlib.G2) *ECP2 {
	if g2 == nil {
		panic("nil argument")
	}
...
func (a *Fp256bn) G2FromProto(e *ECP2) (*mathlib.G2, error) {
	if e == nil {
		return nil, fmt.Errorf("nil argument")
	}
...
func (a *Fp256bnMiracl) G1ToProto(g1 *mathlib.G1) *ECP {
	if g1 == nil {
		panic("nil argument")
	}
...
func (a *Fp256bnMiracl) G1FromRawBytes(raw []byte) (*mathlib.G1, error) {
	l := len(raw) / 2
...
func (a *Fp256bnMiracl) G1FromProto(e *ECP) (*mathlib.G1, error) {
	if e == nil {
		return nil, fmt.Errorf("nil argument")
	}
...
func (a *Fp256bnMiracl) G2ToProto(g2 *mathlib.G2) *ECP2 {
	if g2 == nil {
		panic("nil argument")
	}
...
func (a *Fp256bnMiracl) G2FromProto(e *ECP2) (*mathlib.G2, error) {
	if e == nil {
		return nil, fmt.Errorf("nil argument")
	}
