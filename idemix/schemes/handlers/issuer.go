...
// and implements the schemes.Key interface
...
func (*issuerSecretKey) IsPrivate() bool {
	return true
}
...
func (*issuerPublicKey) IsPrivate() bool {
	return false
}
...
func (g *IssuerKeyGen) KeyGen(opts bccsp.KeyGenOpts) (k bccsp.Key, err error) {
	...
	if !ok {
		return nil, errors.New("invalid options, expected *schemes.IdemixIssuerKeyGenOpts")
	}
...
func (i *IssuerPublicKeyImporter) KeyImport(raw interface{}, opts bccsp.KeyImportOpts) (k bccsp.Key, err error) {
	...
	if !ok {
		return nil, errors.New("invalid options, expected *schemes.IdemixIssuerPublicKeyImportOpts")
	}
...
func (i *IssuerKeyImporter) KeyImport(raw interface{}, opts bccsp.KeyImportOpts) (k bccsp.Key, err error) {
	...
	if !ok {
		return nil, errors.New("invalid options, expected *schemes.IdemixIssuerKeyImportOpts")
	}
