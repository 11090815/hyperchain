...
import (
	...
	"github.com/11090815/hyperchain/common/metrics/metricsfakes"
	gmetrics "github.com/11090815/hyperchain/gossip/metrics"
)
...
func TestUtilConstructMetricProvider() *TestMetricProvider {
	...
	fakeProvider.NewGaugeStub = func(opts metrics.GaugeOpts) metrics.Gauge {
		...
		case gmetrics.DeclarationOpts.Name:
