...
func TestSize(t *testing.T) {
	msgStore := NewMessageStore(alwaysNoAction, func(message interface{}) {})
	msgStore.Add(0)
	msgStore.Add(1)
	msgStore.Add(2)
...
func TestNewMessagesInvalidated(t *testing.T) {
	msgStore := NewMessageStore(compareInts, func(message interface{}) {})
...
func TestExpiration(t *testing.T) {
	...
	msgStore := NewMessageStoreExpirable(nonReplaceInts, func(message interface{}) {}, msgTTL, nil, nil, func(m interface{}) {
		expired <- m.(int)
	})
...
func TestExpirationConcurrency(t *testing.T) {
	...
	msgStore := NewMessageStoreExpirable(nonReplaceInts, func(message interface{}) {}, msgTTL,
		func() {
			lock.Lock()
		},
		func() {
